...
class conv(nn.Module):
    def __init__(self, LEARN):
        ...
        self.scheduler = torch.optim.lr_scheduler.StepLR(self.optimizer, step_size=140, gamma=0.97)
...
if __name__ == '__main__':
    for PRMP in [0.2, 0.4, 0.6, 0.8]:
        ...
        KEYWORD = 'fedtse' + '_' + f'MP_{PRMP}' + f'_{LEARN}' + '_' + datetime.now().strftime("%y%m%d%H%M")
        PATH = '../save_sumo_fedtse_lane/' + KEYWORD

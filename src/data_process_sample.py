...
def load_data_sumo(MA_obs, PRMP, cell_rep, xxx):
    ...
    # train
    X_MA_train = np_X_MA[:len(np_X_MA)*xxx//10]
    X_MP_train = np_X_MP[:len(np_X_MP)*xxx//10]
    Y_train = np_Y[:len(np_Y)*xxx//10]
    X_MP_2_train = np_X_MP_2[:len(np_X_MP_2)*xxx//10]
